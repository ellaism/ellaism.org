...
feature_row:
  ...
  - image_path: mm-free-feature.png
    ...
    btn_label: "Learn More"
intro:
  - excerpt: 'Follow the Ellaism community [<i class="fa fa-twitter"></i> @EllaismCoin](https://twitter.com/EllaismCoin){: .btn .btn--twitter} [Discord](https://discord.gg/66Pn9jn){: .btn .btn--google-plus} [Discourse](https://board.ellaism.io){: .btn .btn--google-plus}'
---
